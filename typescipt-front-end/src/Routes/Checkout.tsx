...
import { INPCHANGE } from "../Redux/actionTypes";
...
const Checkout = () => {
  ...
  const isLoading = useSelector((state: any) => state.CartReducer.isLoading);
  const toggleCart = useSelector((state: any) => state.CartReducer.toggleCart);
  const showOrderPlaced = useSelector(
    (state: any) => state.CartReducer.showOrderPlaced
  );
  const name = useSelector((state: any) => state.CartReducer.name);
  const address = useSelector((state: any) => state.CartReducer.address);
  const pincode = useSelector((state: any) => state.CartReducer.pincode);
  const city = useSelector((state: any) => state.CartReducer.city);
  const state = useSelector((state: any) => state.CartReducer.state);
  ...
  const handlePayBtnClick = (e: any) => {
    ...
    DoPayment(dispatch, toast, isLoading, orderData);
  };
