...
export const AllProduct = () => {
  ...
  const data = useSelector((store: any) => store.ProductReducer.products);
  const totalCount = useSelector(
    (store: any) => store.ProductReducer.totalCount
  );
  const loading = useSelector((store: any) => store.ProductReducer.isLoading);
